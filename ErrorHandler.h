...
struct ErrorHandler{
  ...
  enum Error {UNPHYSICAL = 0, SATURATED_LS = 1, BAD_RIEMANN = 2, REDUCE_TIMESTEP = 3, PRESSURE_CLIPPING = 4, DENSITY_CLIPPING = 5, REDO_TIMESTEP = 6, LARGE_VELOCITY = 7, RAPIDLY_CHANGING_PRESSURE = 8, REDUCE_TIMESTEP_TIME = 9, SIZE = 10};
  ...
  ErrorHandler(Communicator *comIn){
    com = comIn;
    int solverErrorsArray[] = {UNPHYSICAL,SATURATED_LS,BAD_RIEMANN,PRESSURE_CLIPPING,LARGE_VELOCITY, RAPIDLY_CHANGING_PRESSURE, DENSITY_CLIPPING};
