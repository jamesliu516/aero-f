...
void SensitivityAnalysis::setup(const char *name, ClassAssigner *father)
{
  ...
  new ClassToken<SensitivityAnalysis>(ca, "MatrixVectorProduct", this, reinterpret_cast<int SensitivityAnalysis::*>(&SensitivityAnalysis::mvp), 2, "Exact", 0, "FiniteDifference", 1);
  new ClassToken<SensitivityAnalysis>(ca, "MatrixVectorProductViscous", this, reinterpret_cast<int SensitivityAnalysis::*>(&SensitivityAnalysis::mvpViscous), 2, "Exact", 0, "FiniteDifference", 1);
