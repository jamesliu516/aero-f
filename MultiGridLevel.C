...
void MultiGridLevel<Scalar>::setNodeType() {
  ...
  bcpriority[BC_ADIABATIC_WALL_MOVING     ] = 18;
  bcpriority[BC_ISOTHERMAL_WALL_MOVING    ] = 17;
  bcpriority[BC_SLIP_WALL_MOVING          ] = 16;
  bcpriority[BC_MASSFLOW_INLET_MOVING     ] = 15;
  bcpriority[BC_MASSFLOW_OUTLET_MOVING    ] = 14;
  bcpriority[BC_DIRECTSTATE_INLET_MOVING  ] = 13;
  bcpriority[BC_DIRECTSTATE_OUTLET_MOVING ] = 12;
  bcpriority[BC_INLET_MOVING              ] = 11;
  bcpriority[BC_OUTLET_MOVING             ] = 10;
  bcpriority[BC_ADIABATIC_WALL_FIXED      ] =  9;
  bcpriority[BC_ISOTHERMAL_WALL_FIXED     ] =  8;
  bcpriority[BC_SLIP_WALL_FIXED           ] =  7;
