                                                              ...
                                                              DistGeoState &distGeoState)
{
  ...
  //   dom.getCommunicator()->globalSum(1,res0+i);
  //   res0[i] = sqrt(res0[i]);
  // }
  ...
  // DistVec<int> tagLp = new DistVec<int>(dom.getNodeDistInfo());
  // DistVec<int> sortedNodesLp = new DistVec<int>(dom.getNodeDistInfo());
