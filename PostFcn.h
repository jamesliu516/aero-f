...
// Included (MB)
  enum ScalarType {DENSITY = 0, MACH = 1, PRESSURE = 2, TEMPERATURE = 3, TOTPRESSURE = 4,
		   ...
		   DELTA_PLUS = 10, PSENSOR = 11, CSDLES = 12, CSDVMS = 13, MUT_OVER_MU = 14,
                   ...
                   HYDRODYNAMICPRESSURE = 19, WTMACH = 20, WTSPEED = 21, VELOCITY_NORM = 22, 
                   SKIN_FRICTION = 23, SSIZE = 24};
...
*/
  ...
  enum ScalarAvgType {DENSITYAVG = 0, MACHAVG = 1, PRESSUREAVG = 2, TEMPERATUREAVG = 3,
                     TOTPRESSUREAVG = 4, VORTICITYAVG = 5, CSDLESAVG = 6, CSDVMSAVG = 7, SKIN_FRICTIONAVG =8, AVSSIZE = 9};
  enum VectorAvgType {VELOCITYAVG = 0, DISPLACEMENTAVG = 1, AVVSIZE = 2};

// Included (MB)
  enum ScalarDerivativeType {DERIVATIVE_DENSITY = 0, DERIVATIVE_MACH = 1, DERIVATIVE_PRESSURE = 2, DERIVATIVE_TEMPERATURE = 3, DERIVATIVE_TOTPRESSURE = 4, DERIVATIVE_NUT_TURB = 5, DERIVATIVE_EDDY_VISCOSITY = 6, DERIVATIVE_VELOCITY_SCALAR = 7, DSSIZE = 8};
