                                                  ...
                                                  DistSVec<double,dim> &U)
{
  ...
  if (it == 0) {
    ...
    */ 
    this->output->writeBinaryVectorsToDisk(*lastIt, it, t, *this->X, *this->A, U, this->timeState, nodeTag,(DistSVec<double,1>*)0);// 0 for tempPhi because it is not needed anymore. To Be Removed !!!!!
